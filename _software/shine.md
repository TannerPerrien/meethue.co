...
description: |
  ...
  You are only one press away from turning the lights on or off. Home automation was never faster. Choose a dynamic scene, dim the lights or chose from over 16k colors for your lights — all from the comfort of your browser. Works on Mac, Windows, Linux, and Chromebooks.
tags:
- Chrome App
- Paid
